...
typedef struct _nodo_t nodo_t;
typedef struct _lista_t lista_t;
typedef struct _lista_iterador_t lista_iterador_t;
...
/**
 * Libera la memoria reservada por la lista y aplica destructor en cada elemento
 */
...
/**
 * Iterador _interno. Recorre la lista e invoca la funcion con cada elemento de
